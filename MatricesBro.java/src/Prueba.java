    ...
    public static void main(String[] args) throws Exception {
        ...
        switch (opc) {
            ...
            // }
                ...
                // if (columAd != filasBc) {
                //     System.out.println("No se puede realizar la multiplicación porque el número de columnas de A no coincide con el número de filas de B.");
                // } else {
                //     System.out.println("Ingrese los elementos de la matriz A: ");
                //     for (int i = 0; i < filasAd; i++) {
                //         for (int j = 0; j < columAd; j++) {
